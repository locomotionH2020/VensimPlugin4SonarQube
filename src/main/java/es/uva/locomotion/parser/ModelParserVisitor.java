 ...
 */
public interface ModelParserVisitor<T> extends ParseTreeVisitor<T> {
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ModelParser#group}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGroup(ModelParser.GroupContext ctx);
	/**
